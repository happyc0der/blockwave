...
def apply_tick(engine: Engine, actions: list[Action], dt: float) -> list[GameEvent]:
...
def state_digest(engine: Engine) -> str:
...
def verify(replay: Replay) -> tuple[bool, Engine]:
