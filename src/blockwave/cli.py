"""Command line entry point: ``blockwave <command>``."""
...
def _shot(args: argparse.Namespace) -> int:
    ...
    engine = Engine(EngineConfig(seed=args.seed or 0, start_level=args.level))
...
def main(argv: list[str] | None = None) -> int:
    parser = argparse.ArgumentParser(prog="blockwave", description=__doc__)
