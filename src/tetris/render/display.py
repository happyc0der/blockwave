...
puts it on screen, which is why the training loop can skip pygame entirely.
"""
...
class Display:
    def __init__(self, size: tuple[int, int], title: str = "TETRIS", scale: int = 1, vsync: bool = True) -> None:
        pygame.display.init()
        width, height = size
