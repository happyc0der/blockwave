...
The agent and the human look at the same scene through the same code. What
changes between them is not *which* renderer runs but how much decoration this
profile is allowed to spend — and, crucially, decoration is confined to layers
that cannot occlude an occupied playfield cell.
...
#: whether a learning problem is the agent or the vision.
